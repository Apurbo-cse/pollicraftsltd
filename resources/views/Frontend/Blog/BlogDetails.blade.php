                    ...
                    <div class="col-lg-8 mb-4">
                        ...
                        <div class="post post-single">
                            ...
                            <div class="post-content clearfix">
                                ...
                                <figure class="figure">
                                    <img src="{{asset('blog/images/posts/post-lg-2.jpg')}}" class="figure-img img-fluid rounded" alt="...">
                                ...
                                <img src="{{asset('blog/images/posts/single-sm-1.jpg')}}" class="rounded alignleft" alt="...">
                        ...
                        <div class="about-author padding-30 rounded">
                            <div class="thumb">
                                <img src="{{asset('blog/images/other/avatar-about.png')}}" alt="Katen Doe" />
                            </div>
                            <div class="details">
                        ...
                        <div class="section-header">
                            ...
                            <img src="{{asset('blog/images/wave.svg')}}" class="wave" alt="wave" />
                        </div>
                        <!-- post comments -->
                        <div class="comments bordered padding-30 rounded">
                            ...
                            <ul class="comments">
                                ...
                                <li class="comment rounded">
                                    <div class="thumb">
                                        <img src="{{asset('blog/images/other/comment-1.png')}}" alt="John Doe" />
                                    </div>
                                    <div class="details">
                                ...
                                <li class="comment child rounded">
                                    <div class="thumb">
                                        <img src="{{asset('blog/images/other/comment-2.png')}}" alt="John Doe" />
                                    </div>
                                    <div class="details">
                                ...
                                <li class="comment rounded">
                                    <div class="thumb">
                                        <img src="{{asset('blog/images/other/comment-3.png')}}" alt="John Doe" />
                                    </div>
                                    <div class="details">
