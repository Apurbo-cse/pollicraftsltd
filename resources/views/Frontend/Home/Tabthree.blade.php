<div class="col-md-3 product-men">
    <div class="men-pro-item simpleCart_shelfItem">
        ...
        {{-- <div class="item-info-product ">
            <a class="hvr-outline-out button2" href="single.html"
                style="width: 80%; padding-top: 5px;padding-bottom: 5px;font-weight: 600;color: white; margin-bottom: 10px;">
                Formal Blue Shirt
            </a>
        </div> --}}
    </div>
...
<div class="col-md-3 product-men">
    <div class="men-pro-item simpleCart_shelfItem">
        ...
        <div class="item-info-product ">
            <a class="hvr-outline-out button2" href="single.html"
                style="width: 80%; padding-top: 5px;padding-bottom: 5px;font-weight: 600;color: white; margin-bottom: 10px;">Formal
                Blue Shirt</a>
